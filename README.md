...
- `WindNinja_windward-leeward_comparison`  contains derivation for linear model and a run over the DTM, runs windNinja output over DTM using `.asc` files and plots measurement correlation with WindNinja and linear model. Additionally plots windward/leeward component correlations.
