...
- `KestrelCorrelation` contains plot of correlation per averaging time for both kestrels on day 2. uses input `KestrelCorrelation.csv` containing `wind speed` and `time` columns
